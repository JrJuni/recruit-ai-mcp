...
def _base_recruiting_records(*, loaded_at: str) -> dict[str, list[dict]]:
    ...
    candidates = [
        ...
        {
            "candidate_id": "cand_casey_stone",
            "name": "Casey Stone",
            "headline": "Payments platform lead with unverified source evidence",
            "current_company": "PayGrid",
            "current_title": "Senior Payments Engineer",
            "skills": ["Payments", "Kafka", "Risk", "Java", "Kotlin"],
            "domains": ["fintech", "payments", "risk operations"],
            "seniority": "senior",
            "compensation_expectation": {
                ...
                "maximum": 215000,
                "period": "annual",
                "note": "Appears aligned, but evidence has not been captured yet.",
            },
            "locations": ["New York", "Remote US"],
            "work_authorization": "US authorized",
            "availability": "45 days",
            "preferences": {
                ...
                "remote_preference": "remote-first",
                "excluded_companies": [],
                "notes": "Profile is promising but still needs source-backed validation.",
            },
            "risk_flags": [],
            "evidence": [],
            "created_at": loaded_at,
