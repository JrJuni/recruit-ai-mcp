...
Current status: `deal-intel-mcp@0.2.3` is the npm front door. It installs the
...
```powershell
npx.cmd deal-intel-mcp@0.2.3 setup --python "<path-to-python-3.11+>"
npx.cmd deal-intel-mcp@0.2.3 smoke --profile-only
npx.cmd deal-intel-mcp@0.2.3 where --json
npx.cmd deal-intel-mcp@0.2.3 mcpb --json
npx.cmd deal-intel-mcp@0.2.3 mcp-config --json
```
