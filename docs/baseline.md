...
The Python server keeps all 51 handler functions available internally, but MCP
...
- `standard` exposes 47 tools for normal MongoDB-backed operation.
- `developer` exposes all 51 tools, including demo database seed/cleanup.
